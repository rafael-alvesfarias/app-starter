...
var Navegacao = function(target, cfg){
	...
	if(NAVEGACAO_INSTANCE){
		...
		NAVEGACAO_INSTANCE.primeiroElemento = config.primeiroElemento;
		NAVEGACAO_INSTANCE.verticalIndex = 0;
	}else{
		NAVEGACAO_INSTANCE = {
	...
	$(target).keydown(function(event){
		NAVEGACAO_INSTANCE.keyDown.call(NAVEGACAO_INSTANCE, event);
	});
	$(target).keyup(function(event){
		NAVEGACAO_INSTANCE.keyUp.call(NAVEGACAO_INSTANCE, event);
	});
	
	return NAVEGACAO_INSTANCE;
};